        ...
        <nav class="container mx-auto px-4 py-3" aria-label="Primary">
            ...
            <div id="mobile-menu" class="hidden lg:hidden mt-3 pb-4 border-t border-secondary-200">
                <div class="flex flex-col space-y-1 pt-3">
                    ...
                    <a href="/rent-collection" class="mobile-nav-link text-secondary-700 hover:text-primary-700 hover:bg-primary-50 rounded-lg transition-colors font-medium py-2.5 px-3<?= $currentPath === 'rent-collection' ? ' is-active' : '' ?>"<?= $currentPath === 'rent-collection' ? ' aria-current="page"' : '' ?>>Rent Collection</a>
